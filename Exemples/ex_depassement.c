...
/*!
 * \file ex_depassement.c
 * \brief Exemples de voitures (processus) qui "doublent" (lisent/écrivent) sur une route (fichier) 
 * <ul>
 * <li> ici les voitures doublent "sans raison" 
 * <li> elles changent de voie aléatoirement "à l'aveugle" sans savoir s'il y a une voiture en face
 * </ul>
 * C'est un exemple d'utilisation des fonctions de déplacement avec changement de voie 
 */

/*! Nom du fichier route par défaut */
#define FICHIER_TEST "../Fichiers/exemple_route_v2.bin"
